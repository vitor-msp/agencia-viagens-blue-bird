...
namespace AgenciaViagens.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(ClienteRegistro model)
        {
            using (AgenciaViagensEntities db = new AgenciaViagensEntities())
            {
                ViewBag.erro = null;
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        try
                        {
                            ...
                            cliente.rg = model.cliente.rg;
                            cliente.cpf = model.cliente.cpf.Replace(".", "").Replace("-", "");
                            cliente.dt_nasc = model.cliente.dt_nasc;
                            cliente.email= model.registro.Email;
